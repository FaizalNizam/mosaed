    ...
    return (
        <View style={{ backgroundColor: '#FAFBFD' }}>
            <LinearGradient colors={['#2ECBAA', '#387FDA']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={{ height: height * .143 }}>
                ...
                <Text style={{ alignSelf: 'center', marginTop: height * .06, fontSize: 22, color: 'white' }}>Terms And Conditions</Text>
            </LinearGradient>

            <ScrollView style={{ marginHorizontal: width * .0513, height: height * .83 }}>
                <Text style={{ fontSize: 16, color: '#363636', marginTop: height * .0513 }}>
            ...
            <View style={{ height: height * .133, width: width * .99991, backgroundColor: 'white', borderTopLeftRadius: 20, borderTopRightRadius: 20, alignItems: 'center', justifyContent: 'center', position: 'absolute', bottom: 0 }}>
                <Button title={'I agree'} width={width * .642} />
            </View>
